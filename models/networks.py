...
def ResNet(input_data, nb_res_blocks, nrow_GLOB, ncol_GLOB, n_echo):
    """
    ...
    input_data = tf.reshape(input_data, [-1, nrow_GLOB, ncol_GLOB, n_echo * 2])

    conv_filters = dict([('w1', (3, 3, n_echo * 2, 64)), ('w2', (3, 3, 64, 64)), ('w3', (3, 3, 64, n_echo * 2))])
    ...
    nw_output = tf.reshape(nw_output, [-1, nrow_GLOB, ncol_GLOB, n_echo, 2])
